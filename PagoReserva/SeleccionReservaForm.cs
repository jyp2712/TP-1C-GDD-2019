    ...
    public partial class SeleccionReservaForm : Form
    {
        ...
        private void btnIngresarAlPago_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                PagoReservaForm formReserva = new PagoReservaForm();
            }
