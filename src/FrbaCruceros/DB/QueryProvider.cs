...
namespace FrbaCrucero.DB
{
    class QueryProvider
    {
        ...
        public static string SELECT_RECORRIDOS = "select r. reco_id, r.reco_codigo, r.reco_origen_id, r.reco_destino_id, SUM(r.reco_precio) reco_precio from EYE_OF_THE_TRIGGER.Recorrido r where r.reco_estado=1 AND r.reco_origen_id = (SELECT TOP 1 r1.reco_origen_id FROM EYE_OF_THE_TRIGGER.Recorrido r1 WHERE r1.reco_codigo = r.reco_codigo ORDER BY r1.reco_id) AND r.reco_destino_id = (SELECT TOP 1 r1.reco_origen_id  FROM EYE_OF_THE_TRIGGER.Recorrido r1 WHERE r1.reco_codigo = r.reco_codigo ORDER BY r1.reco_id DESC) GROUP BY r. reco_id, r.reco_codigo, r.reco_origen_id, r.reco_destino_id";
        ...
        public static string SELECT_TODOS_RECORRIDOS = "SELECT * FROM [GD1C2019].[EYE_OF_THE_TRIGGER].[Recorrido] where reco_estado=1";
        ...
        {
            return "select * from EYE_OF_THE_TRIGGER.Recorrido r where r.reco_estado=1 AND reco_id=" + id;
        }
