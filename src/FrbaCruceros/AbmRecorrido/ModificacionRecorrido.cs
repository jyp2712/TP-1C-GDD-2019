    ...
    DataSet ds;
        ...
        private void dataGridViewRecorridos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                e.RowIndex >= 0)
            {
                ...
                int selected_recorrido_id = Convert.ToInt32(selectedRow.Cells["reco_codigo"].Value);
                int id = Convert.ToInt32(selectedRow.Cells["reco_id"].Value);

                ModificacionRecorridoForm modifForm = new ModificacionRecorridoForm(id, selected_recorrido_id);
                modifForm.Show();
        ...
        public static void initializeDataGridView(DataGridView dgv, ref DataSet ds)
        {
            ...
            ds = dbConnection.executeQuery(QueryProvider.SELECT_TODOS_RECORRIDOS);
            dgv.ReadOnly = true;
