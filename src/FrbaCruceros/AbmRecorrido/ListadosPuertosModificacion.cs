...
{
    public partial class ListadosPuertosModificacion : Form
    {
        ...
        public ListadosPuertosModificacion(ref TextBox txtToModify, Boolean isOrigen)
        {
            InitializeComponent();
        ...
        public ModificacionRecorridoForm RefToPrevForm { get; set; }
